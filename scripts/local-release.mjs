...
const packages = [
	{ directory: "packages/ai", name: "@lastwar/pi-ai" },
	{ directory: "packages/tui", name: "@lastwar/pi-tui" },
	{ directory: "packages/agent", name: "@lastwar/pi-agent-core" },
	{ directory: "packages/coding-agent", name: "@lastwar/pi-coding-agent" },
];
